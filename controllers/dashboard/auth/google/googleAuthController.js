import { googleLogin, googleTokenLogin } from '../../../../services/dashboard/auth/google/googleAuthService.js';
...
export const googleCallbackController = async (req, res) => {
  try {
    ...
    res.status(200).json({ success: true, message: authMessages.googleAdminLoginSuccess, data: result });
  } catch (error) {
